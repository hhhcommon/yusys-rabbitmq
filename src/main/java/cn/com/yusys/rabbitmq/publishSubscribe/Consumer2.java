...
public class Consumer2 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        // 声明交换机
        channel.exchangeDeclare(Producer.FANOUR_EXCHANGE,BuiltinExchangeType.FANOUT);
         ...
         */
        // 创建消费者，并设置消费处理
        channel.queueDeclare(Producer.FANOUR_QUEUE_2, true, false, false, null);

        // 队列绑定交换机
        channel.queueBind(Producer.FANOUR_QUEUE_2,Producer.FANOUR_EXCHANGE,"");
         ...
         */
        channel.basicConsume(Producer.FANOUR_QUEUE_2, true, consumer);
