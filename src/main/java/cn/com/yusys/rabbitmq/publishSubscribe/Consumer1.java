...
public class Consumer1 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
         ...
         */
        // 创建消费者，并设置消费处理
        channel.queueDeclare(Producer.FANOUR_QUEUE_1, true, false, false, null);

        // 队列绑定交换机
        channel.queueBind(Producer.FANOUR_QUEUE_1,Producer.FANOUR_EXCHANGE,"");
         ...
         */
        channel.basicConsume(Producer.FANOUR_QUEUE_1, true, consumer);
